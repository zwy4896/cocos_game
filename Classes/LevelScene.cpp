...
bool LevelScene::init()
{
    ...
    auto bk = Sprite::create("UI/LEVEL/LEVEL_UI_UP_0000s_0002_BK.png");
...
//    背景平铺
	...
	logo->setPosition(winSize.width / 2, CD_FLOAT("level_scene_logo_y"));
	this->addChild(logo);
	...
	for (int i = 1; i <= 8; i++)
	{
		...
		auto bm = MenuItemImage::create(but_name_up, but_name_down, "UI/LEVEL/button_not_level.png", CC_CALLBACK_1(LevelScene::levelsCallBack, this));
